...
namespace Ssm.Engine.ScriptStatements {
    ...
    /// 定义一个变量
    /// </summary>
    public class Import : ISemanticStatement {
        ...
        /// 获取类型
        /// </summary>
        public ScriptSemanticTypes Type { get { return ScriptSemanticTypes.Import; } }
            ...
            for (int i = 0; i < strs.Length; i++) {
                ...
                for (int j = 0; j < engine.SirScript.Datas.Count; j++) {
                    ...
                    if (data.Index == idx) {
                        ...
                        engine.SirScript.Imports.Add(SirImportTypes.Lib, fileName);
